...
Create a new user. Read more on creating new user in [VirtoCommerce documentation](https://virtocommerce.com/docs/vc2userguide/users-management-roles-and-role-assignment).

Create Hmac API key for the user. Give the user permissions to manage Catalogs and orders. For more information read [VirtoCommerce documentation](https://virtocommerce.com/docs/vc2userguide/users-management-roles-and-role-assignment)
